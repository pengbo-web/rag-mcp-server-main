...
|---------|---------|------|---------|------|
| A1 | 初始化目录树与最小可运行入口 | [x] | 2026-02-01 | 已创建完整项目骨架、Settings 模块与测试套件 |
| A2 | 引入 pytest 并建立测试目录约定 | [x] | 2026-02-01 | 已建立测试目录、冒烟测试、样例文档 |
| A3 | 配置加载与校验（Settings） | [x] | 2026-02-01 | 已实现 Settings 加载、验证与测试 |

#### 阶段 B：Libs 可插拔层

| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| B1 | LLM 抽象接口与工厂 | [x] | 2025-01-17 | 12个测试，commit 7d6ea45 |
...
| B6 | Evaluator 抽象接口与工厂 | [x] | 2025-01-17 | 20个测试，commit d7cfc67 |
| B7.1 | OpenAI-Compatible LLM 实现 | [x] | 2026-02-03 | 24个测试（OpenAI/Azure/DeepSeek） |
